      ...
      <header className="sticky top-0 z-[101] bg-white/80 backdrop-blur-md border-b border-border">
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-5">
            ...
            <a href="#contact" data-track="nav_click" data-track-section="contact">
          ...
          >
            <div className="flex gap-3">
              <a
                ...
                onClick={close}
                data-track="whatsapp_click" data-track-location="mobile_menu" data-track-also="cta_click"
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={close}
                data-track="calendly_click" data-track-location="mobile_menu" data-track-also="cta_click"
            ...
            <a href="#contact" onClick={close} data-track="nav_click" data-track-section="contact">
