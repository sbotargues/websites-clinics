      ...
      <header className="sticky top-0 z-[101] bg-white/80 backdrop-blur-md border-b border-border">
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-5">
            <a href="#demos" className="nav-link text-sm text-foreground">{t.nav.demos}</a>
            <a href="#features" className="nav-link text-sm text-foreground">{t.nav.features}</a>
            <a href="#faq" className="nav-link text-sm text-foreground">{t.nav.faq}</a>
            <a href="#contact">
